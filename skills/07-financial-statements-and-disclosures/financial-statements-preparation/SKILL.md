...
Use when a finance, accounting, reporting, controls, systems, or sector workflow needs financial-statement preparation, classification, statement mapping, disclosure assembly, going-concern evidence, and audit-ready tie-outs.
...
| Reviewer roles | Reporting owner; IFRS reviewer; auditor liaison where audit evidence is affected |
