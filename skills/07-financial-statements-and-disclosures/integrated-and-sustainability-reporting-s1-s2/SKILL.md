...
# Integrated And Sustainability Reporting S1 S2

<!-- dual-compat-start -->
## Use When

Use when a finance, accounting, reporting, controls, systems, or sector workflow needs sustainability-related financial disclosure, emissions data governance, controls over non-financial metrics, and linkage to financial reporting.
...
| Reviewer roles | Sustainability reviewer; IFRS/ISSB reviewer; controller where financial reporting is affected |
