# Source Basis - Integrated And Sustainability Reporting S1 S2
...
| ISSB-S1-S2 | IFRS Foundation - IFRS Sustainability Disclosure Standards knowledge hub | 1 - official standard-setter | https://www.ifrs.org/sustainability/knowledge-hub/introduction-to-issb-and-ifrs-sustainability-disclosure-standards/ | IFRS S1 and IFRS S2 routing for sustainability-related financial disclosures. |
| GHG-PROTOCOL | Greenhouse Gas Protocol - Corporate Accounting and Reporting Standard | 1 - standards body | https://ghgprotocol.org/corporate-standard | Emissions inventory boundary, scope, activity-data, and factor-governance design. |
