...
# Forensic Accounting And Anti Fraud

<!-- dual-compat-start -->
## Use When

Use when a finance, accounting, reporting, controls, systems, or sector workflow needs preventive, detective, corrective, and assurance controls over finance processes and ethical conduct.
...
| Reviewer roles | Controls owner; ethics reviewer where conduct is affected |
