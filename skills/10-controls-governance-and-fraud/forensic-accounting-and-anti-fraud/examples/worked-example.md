# Worked Example - Forensic Accounting And Anti Fraud
...
An entity asks the finance engine to process a matter involving preventive, detective, corrective, and assurance controls over finance processes and ethical conduct. The preparer provides a source document, account map, reporting period, functional currency, and management explanation. The source-register snapshot contains no final statutory value for this example, so no statutory amount is released.
