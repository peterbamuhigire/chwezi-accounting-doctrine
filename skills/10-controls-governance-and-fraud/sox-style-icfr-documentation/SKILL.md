...
Use when an entity needs SOX-style ICFR-equivalent documentation: process narratives, risk-control matrices, walkthroughs, and design/operating-effectiveness testing.
