...
Use when finance touches AML/CFT scope: customer due diligence, sanctions screening, suspicious-transaction triggers, regulator reporting, and record-keeping.
