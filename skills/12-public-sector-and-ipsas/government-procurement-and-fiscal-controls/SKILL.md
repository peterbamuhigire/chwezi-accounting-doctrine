...
metadata:
  portable: true
  category: 12-public-sector-and-ipsas
  compatible_with:
    - claude-code
    - codex
---

# Government Procurement And Fiscal Controls

<!-- dual-compat-start -->
## Use When

Use when a finance, accounting, reporting, controls, systems, or sector workflow needs public-sector accounting overlays, budgetary control, donor restrictions, procurement evidence, and fund accountability.
...
- Read doctrine/references/uganda-public-sector-pfm.md when the engagement is Ugandan.
...
| Reviewer roles | Public-sector reviewer; donor compliance reviewer where donor funds are affected |
