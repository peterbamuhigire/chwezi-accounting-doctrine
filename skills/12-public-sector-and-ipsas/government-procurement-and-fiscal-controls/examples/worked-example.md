# Worked Example - Government Procurement And Fiscal Controls
...
An entity asks the finance engine to process a matter involving public-sector accounting overlays, budgetary control, donor restrictions, procurement evidence, and fund accountability. The preparer provides a source document, account map, reporting period, functional currency, and management explanation. The source-register snapshot contains no final statutory value for this example, so no statutory amount is released.
