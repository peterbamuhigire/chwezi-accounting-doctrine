...
Use when designing petty cash and imprest float controls: float size, replenishment, custodian rotation, surprise counts, evidence requirements, and ledger postings.
