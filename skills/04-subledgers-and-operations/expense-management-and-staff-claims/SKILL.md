...
Use when designing employee expense, advance, and claim workflows: receipt capture, mileage, per diem, VAT recovery, multi-currency, approval, and reimbursement posting.
