...
Operational subledgers that feed the general ledger: banking, mobile money, inventory, fixed assets, and payroll.

## Skills in this category

| Skill | Status |
|---|---|
| `bank-and-mobile-money-reconciliation` | active |
