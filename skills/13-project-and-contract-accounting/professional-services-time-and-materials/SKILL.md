...
Use when a finance, accounting, reporting, controls, systems, or sector workflow needs project cost capture, work-in-progress, contract assets/liabilities, retention, variations, claims, and billing evidence.
...
| Reviewer roles | Project accounting reviewer; IFRS reviewer; delivery owner |
