...
Use when documenting related-party transactions for transfer-pricing purposes: master file, local file, CbC reporting thresholds, and benchmarking evidence.
