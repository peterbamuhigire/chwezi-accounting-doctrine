...
# indirect-tax-vat-mechanics

<!-- dual-compat-start -->
## Use When

Use when designing VAT/GST mechanics: place of supply, reverse charge, mixed supplies, input VAT recovery, partial exemption, and adjustments.
