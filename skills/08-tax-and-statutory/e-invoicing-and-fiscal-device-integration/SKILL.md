...
Use when integrating with fiscal devices and e-invoicing platforms (EFRIS, eTIMS, EBM, etc.): document numbering, signing, transmission, void/credit, and reconciliation to the ledger.
