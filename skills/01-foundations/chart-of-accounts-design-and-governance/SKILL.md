...
Use when a finance, accounting, reporting, controls, systems, or sector workflow needs foundation policy, master-data governance, period state, framework routing, and ledger control.
...
| Reviewer roles | Doctrine owner; accounting systems architect; controller |
