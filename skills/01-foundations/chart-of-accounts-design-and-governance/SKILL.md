...
Use when designing, reviewing, or governing the Chart of Accounts: account taxonomy, normal-balance enforcement, control-account ownership, dimension requirements, direct-posting permissions, evidence requirements, and CoA change control.
