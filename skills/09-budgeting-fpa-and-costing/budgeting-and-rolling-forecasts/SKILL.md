...
metadata:
  portable: true
  category: 09-budgeting-fpa-and-costing
  compatible_with:
    - claude-code
    - codex
---
...
Use when a finance, accounting, reporting, controls, systems, or sector workflow needs budget ownership, forecast cadence, variance explanation, scenario evidence, cost behaviour, and management-reporting tie-outs.
...
| Reviewer roles | Management accountant; controller; commercial owner where pricing is affected |
