...
Use when ensuring finance UI meets accessibility standards: keyboard parity, screen-reader semantics for ledger tables, colour-independent semantic states, and localisation/RTL.
