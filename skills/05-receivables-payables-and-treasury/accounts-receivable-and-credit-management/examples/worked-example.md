# Worked Example - Accounts Receivable And Credit Management
...
An entity asks the finance engine to process a matter involving working-capital control, AR/AP discipline, liquidity forecasting, banking facilities, FX exposure, and covenant evidence. The preparer provides a source document, account map, reporting period, functional currency, and management explanation. The source-register snapshot contains no final statutory value for this example, so no statutory amount is released.
