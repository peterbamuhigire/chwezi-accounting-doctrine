...
metadata:
  portable: true
  category: 05-receivables-payables-and-treasury
  compatible_with:
    - claude-code
    - codex
---
...
Use when a finance, accounting, reporting, controls, systems, or sector workflow needs working-capital control, AR/AP discipline, liquidity forecasting, banking facilities, FX exposure, and covenant evidence.
...
| Reviewer roles | Treasury reviewer; controller; IFRS reviewer where financial instruments or FX are affected |
