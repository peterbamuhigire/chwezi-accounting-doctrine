# Worked Example - Continuous Close And Flash Reporting
...
An entity asks the finance engine to process a matter involving close cadence, PBC evidence, reconciliations, review queues, flash reporting, and auditor-ready support. The preparer provides a source document, account map, reporting period, functional currency, and management explanation. The source-register snapshot contains no final statutory value for this example, so no statutory amount is released.
