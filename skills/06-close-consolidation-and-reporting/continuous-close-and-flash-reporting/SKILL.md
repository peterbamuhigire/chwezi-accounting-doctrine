...
# Continuous Close And Flash Reporting

<!-- dual-compat-start -->
## Use When

Use when a finance, accounting, reporting, controls, systems, or sector workflow needs close cadence, PBC evidence, reconciliations, review queues, flash reporting, and auditor-ready support.
...
| Reviewer roles | Close owner; controller; auditor liaison |
