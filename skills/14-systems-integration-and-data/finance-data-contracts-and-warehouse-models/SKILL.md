...
Use when shipping finance data to BI/warehouse: conformed dimensions, slowly changing dimensions for CoA, partition keys, and reconciliation back to the GL.
