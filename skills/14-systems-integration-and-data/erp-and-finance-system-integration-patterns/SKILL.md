...
Use when integrating Chwezi finance modules with external ERPs or SaaS finance systems: master-data sync, event vs batch, idempotency, and reconciliation watchers.
