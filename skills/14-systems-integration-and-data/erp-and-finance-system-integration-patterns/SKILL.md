...
metadata:
  portable: true
  category: 14-systems-integration-and-data
  compatible_with:
    - claude-code
    - codex
---

# ERP And Finance System Integration Patterns

<!-- dual-compat-start -->
## Use When

Use when a finance, accounting, reporting, controls, systems, or sector workflow needs finance API contracts, idempotency, reconciliation, data lineage, warehouse facts, and secure payment integration.
...
| Reviewer roles | Integration owner; data owner; security reviewer where payment data is affected |
