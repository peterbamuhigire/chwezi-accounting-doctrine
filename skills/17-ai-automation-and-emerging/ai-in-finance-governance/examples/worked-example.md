# Worked Example - AI In Finance Governance
...
An entity asks the finance engine to process a matter involving AI governance, human approval, evidence retention, model-risk controls, and prohibition of autonomous final accounting judgement. The preparer provides a source document, account map, reporting period, functional currency, and management explanation. The source-register snapshot contains no final statutory value for this example, so no statutory amount is released.
