...
# RPA And Automation Controls For Finance

<!-- dual-compat-start -->
## Use When

Use when a finance, accounting, reporting, controls, systems, or sector workflow needs bot identity, segregation of duties, exception handling, kill-switches, and reconciled automation evidence.
...
| Reviewer roles | Controls owner; automation owner; finance controller |
