...
# IFRS Accounting Policies Changes Errors Ias8

<!-- dual-compat-start -->
## Use When

Use when a finance, accounting, reporting, controls, systems, or sector workflow needs recognition, measurement, presentation, disclosure, transition choices, and ledger evidence under the applicable IFRS or IFRS for SMEs framework.
...
| Reviewer roles | IFRS reviewer; controller where postings are affected |
