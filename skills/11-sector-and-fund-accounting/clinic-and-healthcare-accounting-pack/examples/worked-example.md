# Worked Example - Clinic And Healthcare Accounting Pack
...
An entity asks the finance engine to process a matter involving sector-specific source events, controls, reporting views, tax touchpoints, and accounting classifications. The preparer provides a source document, account map, reporting period, functional currency, and management explanation. The source-register snapshot contains no final statutory value for this example, so no statutory amount is released.
