...
# hospitality-and-restaurant-pack

<!-- dual-compat-start -->
## Use When

Use for hotels, lodges, and restaurants: room nights, package allocations, F&B recipe costing, tips and service-charge handling, and tour-operator commissions.
