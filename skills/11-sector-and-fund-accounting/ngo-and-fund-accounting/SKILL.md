...
- examples/uganda-worked-example.md shows a Ugandan restricted multi-currency donor-grant fixture (deferred income, weighted-average flexing, budget-vs-flexed-vs-actual variance) using illustrative org-policy figures, not statutory rates.
