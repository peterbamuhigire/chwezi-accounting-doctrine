...
Use when classifying finance data (PII, financial, statutory) and setting retention, lawful basis, cross-border transfer, and right-to-erasure rules consistent with statutory retention minima.
