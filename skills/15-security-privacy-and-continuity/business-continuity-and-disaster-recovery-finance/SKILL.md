...
Use when planning continuity and disaster recovery for finance operations: RPO/RTO per finance system, payroll fallback, bank-payment fallback, and tabletop exercises.
