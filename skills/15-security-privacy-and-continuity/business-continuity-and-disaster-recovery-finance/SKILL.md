...
metadata:
  portable: true
  category: 15-security-privacy-and-continuity
  compatible_with:
    - claude-code
    - codex
---

# Business Continuity And Disaster Recovery Finance

<!-- dual-compat-start -->
## Use When

Use when a finance, accounting, reporting, controls, systems, or sector workflow needs finance-data confidentiality, integrity, availability, retention, payment privilege hardening, and recovery evidence.
...
| Reviewer roles | Security reviewer; privacy reviewer; finance controller |
